  ...
  return (
    <div className={classes.mainDiv}>
      ...
      <center>
          ...
          <form>
            <input className={classes.inpEmail} placeholder='Enter your email' type="email"/> <br/>
            <input 
            ...
            />
            <br/>
            <a className={classes.frgtPass} href="#">Forgot Password?</a>
            <br/>
            <button type="submit" className={classes.btn}>Login</button>
            <br/>
            <button type="submit" className={classes.newBtn}>Register</button>
